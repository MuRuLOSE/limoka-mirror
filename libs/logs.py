...
class BHikkamodsLogsLib(loader.Library):
    ...
    def __init__(self):
        self.config = loader.LibraryConfig(loader.ConfigValue('send_errors', False, 'Send errors to developer for diagnostic', validator=loader.validators.Boolean()), loader.ConfigValue('send_id', False, 'Send id with error'))
